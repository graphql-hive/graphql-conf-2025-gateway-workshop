...
export DOCKER_TAG=":677fd50be721817ca8cef23d4062d4ae3fce2aaf"
export HIVE_ENCRYPTION_SECRET="35a71aacfa694da78c90f7eb37531fc1"
export HIVE_APP_BASE_URL="http://ec2-52-28-73-22.eu-central-1.compute.amazonaws.com"
export HIVE_EMAIL_FROM="no-reply@graphql-hive.com"
export SUPERTOKENS_API_KEY="8921636e1b4f49008f866553467a72ae"
export CLICKHOUSE_USER="clickhouse"
export CLICKHOUSE_PASSWORD="91d74b69b3eb4f5d9489a813e0a45841"
export REDIS_PASSWORD="6a9af73a20d64e35b0d27fc2ffc9c046"
export POSTGRES_USER="postgres"
export POSTGRES_PASSWORD="2743f19d105540f7bdec6122c1f46325"
export POSTGRES_DB="registry"
export MINIO_ROOT_USER="minioadmin"
export MINIO_ROOT_PASSWORD="minioadmin"
export CDN_AUTH_PRIVATE_KEY="d223052b2609484b828f2e2573b40024"
```
...
services:
  ...
  broker:
    ...
    command:
      ...
      - PLAINTEXT://broker:29092,OUTSIDE://ec2-52-28-73-22.eu-central-1.compute.amazonaws.com:9092
      - --pandaproxy-addr
      - PLAINTEXT://0.0.0.0:27082,OUTSIDE://0.0.0.0:7082
      - --advertise-pandaproxy-addr
      - PLAINTEXT://broker:27082,OUTSIDE://ec2-52-28-73-22.eu-central-1.compute.amazonaws.com:7082
      - --advertise-rpc-addr redpanda-1:33145
    mem_limit: 300m
    mem_reservation: 100m
    healthcheck:
      test: "curl -f http://ec2-52-28-73-22.eu-central-1.compute.amazonaws.com:9644/public_metrics"
      interval: 3s
      timeout: 3s
      retries: 6
      start_period: 5s
    ...
    healthcheck:
      test:
        [
          ...
          "curl",
          "-f",
          "http://ec2-52-28-73-22.eu-central-1.compute.amazonaws.com:9000/minio/health/live",
        ]
      interval: 30s
      timeout: 20s
      retries: 3
  ...
  server:
    ...
    environment:
      ...
      CDN_API: "1"
      CDN_API_BASE_URL: "http://ec2-52-28-73-22.eu-central-1.compute.amazonaws.com:8082"
      LOG_LEVEL: "${LOG_LEVEL:-debug}"
      # Auth
      ...
      GRAPHQL_PUBLIC_ORIGIN: http://ec2-52-28-73-22.eu-central-1.compute.amazonaws.com:8082
      # Tracing
  ...
  app:
    ...
    environment:
      ...
      GRAPHQL_PUBLIC_ENDPOINT: http://ec2-52-28-73-22.eu-central-1.compute.amazonaws.com:8082/graphql
      GRAPHQL_PUBLIC_SUBSCRIPTION_ENDPOINT: http://ec2-52-28-73-22.eu-central-1.compute.amazonaws.com:8082/graphql
      GRAPHQL_PUBLIC_ORIGIN: http://ec2-52-28-73-22.eu-central-1.compute.amazonaws.com:8082
      AUTH_REQUIRE_EMAIL_VERIFICATION: "0"
      AUTH_ORGANIZATION_OIDC: "1"
      LOG_LEVEL: "${LOG_LEVEL:-debug}"
...
SET "feature_flags" = '{"otelTracing": true, "appDeployments": true}'
;
```
